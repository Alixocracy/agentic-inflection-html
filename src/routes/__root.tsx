...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Payments Canada Summit 2026 redrew the map for AI, trust, and the future of money." },
      { property: "og:description", content: "How Payments Canada Summit 2026 redrew the map for AI, trust, and the future of money." },
      { name: "twitter:description", content: "How Payments Canada Summit 2026 redrew the map for AI, trust, and the future of money." },
    ],
    links: [
      {
        rel: "stylesheet",
